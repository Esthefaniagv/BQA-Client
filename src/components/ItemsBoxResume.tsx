...
export const ItemsBoxResume = ({ selectedProduct }: { selectedProduct: IProduct }) => {
  ...
  function quantities({ numberOne, sumQuantity }) {
    return <p>{numberOne}</p>;
  }
//   const resQuantity= () => {
//     setQuantity(quantity - 1)
// }
      ...
      <div className='sectionItemsResume'>
        <section>
          <div className="clientName">
              <input value={clientName} onChange={handleClientName} type="text" className="form-control mb-3" placeholder="Escribe nombre de cliente aquí" aria-label="Username" aria-describedby="basic-addon1" />
              <p>Cuenta de {clientName}</p>
          </div>
              ...
              <>
                ...
                <div className='divIconsResume'>
                  <div className='iconsPlusLess'>
                    <button className="buttonDecrease" onClick={resQuantity}>
                      <svg
                    ...
                    <button className="buttonIncrease" onClick={sumQuantity}>
                      <svg
                        xmlns='http://www.w3.org/2000/svg'
                        width='20'
                        height='20'
