    ...
    return (
        <Fragment>
          ...
          />
                ...
                <hr />
                <button className='unstyle homeWaiterBtn' onClick={allDoneOrders}>Pedidos<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-alarm-fill ps-1" viewBox="0 0 16 16">
